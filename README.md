...
<h3 align="center">Este projeto foi feito em PHP com o framework Laravel.</h3>

---

**Requisitos**

-   [PHP 8.3|8.4](https://php.net/downloads).
-   [Composer 2.x](https://getcomposer.org/download).
-   [NodeJs 22.x](https://nodejs.org/en/download).
-   [Laravel 12.x](https://laravel.com/docs/install).
